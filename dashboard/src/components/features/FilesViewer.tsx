  ...
  return (
    ...
    >
      ...
      <Show
        ...
        fallback={
          <p class="px-4 py-4 text-sm text-[hsl(var(--muted-foreground))]">No file events yet</p>
        }
      >
        <div class="px-1 pb-2">
  ...
  return (
    <>
      ...
      >
        ...
        <Show when={props.node.fileEntry && props.node.fileEntry.versions.length > 0}>
          <span
            class={cn(
          ...
          <>
              ...
              <For each={f().versions}>
                {(version, idx) => {
                  ...
                  return (
                    ...
                    >
                      v{idx() + 1}
                      <span class="ml-1 text-[10px] opacity-70">{formatTime(version.ts_wall)}</span>
                    </button>
                  );
                }}
              </For>
            ...
            <Show when={compareVersionIdx() !== null}>
              <span class="shrink-0 text-[10px] text-blue-400">
                diff: v{compareVersionIdx()! + 1} → v{selectedVersionIdx()! + 1}
              </span>
            </Show>
